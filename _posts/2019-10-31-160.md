...
event_date:      
summary:         "whoops"
content_flags:   [Animal Harm, Animal Death]
acast_url:       
pdf:             
accessible_pdf:  
google_doc:      
...
still I'd requested Detective Tonner be assigned to the case when they found Gertrude's body in the hope that having a Hunter in the mix would eventually lead to a confrontation 
...
honestly Detective Tonner has proven invaluable through this whole process 
